...
public class GlobalExceptionHandler {
	 ...
	 @ExceptionHandler(HttpMessageNotReadableException.class)
	    public ResponseEntity<ResponseErrorDto> handleJsonError(
	    ...
	    public ResponseEntity<ResponseErrorDto> handleDBError(
	            DataIntegrityViolationException ex) {

	        return buildError(
	                HttpStatus.BAD_REQUEST,
	                "Invalid data. Required fields may be missing."
	        );
	    }
	    ...
	    private ResponseEntity<ResponseErrorDto> buildError(
	    ...
	    public ResponseEntity<ResponseErrorDto> handleFeignException(
	            FeignException ex) {

	        return buildError(
	                HttpStatus.SERVICE_UNAVAILABLE,
	                "Category service is unavailable. Please try again later."
	        );
	    }
